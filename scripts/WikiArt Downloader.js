...
(function() {
    ...
    function savePaintingAs () {
        ...
        let saveAsName = `${painting.artistName} - ${painting.year} - ${painting.title}.${imgExtension}`;
    ...
    //TODO - if I make the css more specific (e.g. span.classname) then "!important" is not necessary - good practice
    GM_addStyle ( `
