...
(function() {
    ...
    function modifyCharSheet() {
        ...
        // MAYBE make a class with properties "element" and "buttonPos"
        const region = {
            Sidebar: document.querySelector('#divBuildLevels'),
            Sheet: document.querySelector('.tabbed-area-display-holder'),
        }

        // TODO : add observer (for when features change/are added)
        addButtons(region.Sidebar)

        // Check if tab, character level or features change (which recreates the content of the tabbed display area)
